import { View, Text, StyleSheet, ScrollView,Dimensions,
    TouchableOpacity, Image, TextInput, Modal,Platform, SafeAreaView,ActivityIndicator } from 'react-native'
import React, {
...
const LoanBr = ({ navigation }) => {
    ...
    const applyLoan = async() =>{
      ...
      setShowLoader(true);
       axios({
         method:'POST',
         url:'https://node-realestate.mobiloitte.com/api/v1/loan/requestLoan',
         data:{
          firstName:FirstName,
          lastName:FirstName,
         ...
         console.log('Response loan application',response.data);
         setShowLoader(false);
                    ...
                    <View>
                        <TouchableOpacity onPress={() => {visible() }}
                            ...
                            <Text
                                ...
                                {showLoader ? <ActivityIndicator color={"white"} /> : "APPLY"}
                            </Text>
                        </TouchableOpacity>
                    </View>
