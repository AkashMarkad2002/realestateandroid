...
<Entypo name="cross" size={25} color={'white'} style={{alignSelf:'flex-end'}} />
            ...
            <View style={{ padding: 20, justifyContent: 'center' }}>
              ...
              <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', marginTop: 15, backgroundColor: '#000', width: 100, padding: 7, alignSelf: 'center', borderRadius: 100 }}
...
const styles = StyleSheet.create({
  ...
  propertyName: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', flexShrink: 2, marginVertical: 3
  },
  propertyTitle: {
