    ...
    <View
      ...
      <View>
        <Image
          ...
          style={{ width: width * 0.35, borderRadius: 10,height: height * 0.25,}}
        />
      </View>
      <View style={styles.propertyInfo}>
        ...
        <View style={{ width: '100%', margin: '2%' }}>
          <View style={{ flexDirection: 'row', width: '80%', alignItems: 'center', marginBottom: '2%' }}>
            <Text style={{ width: '45%', fontSize: 10,color:'#696969' ,fontFamily:'Lato-Regular' }}>Broker Name</Text>
            <Text style={{ width: '10%', fontSize: 10, color: '#000000',fontFamily:'Lato-Regular'  }}>:</Text>
            <Text style={{ width: '45%', fontSize: 10, color: '#000000',fontFamily:'Lato-Regular'  }}>Rajan Pathak</Text>
          </View>
          <View style={{ flexDirection: 'row', width: '80%', alignItems: 'center', marginBottom: '2%' }}>
            <Text style={{ width: '45%', fontSize: 10,color:'#696969',fontFamily:'Lato-Regular'  }}>Client Name</Text>
            <Text style={{ width: '10%', fontSize: 10, color: '#000000',fontFamily:'Lato-Regular'  }}>:</Text>
            <Text style={{ width: '45%', fontSize: 10, color: '#000000', fontFamily:'Lato-Regular'  }}>Abhinav</Text>
          </View>
          <View style={{ flexDirection: 'row', width: '80%', alignItems: 'center', marginBottom: '2%' }}>
            <Text style={{ width: '45%', fontSize: 10,color:'#696969',fontFamily:'Lato-Regular'  }}>Attendee</Text>
            <Text style={{ width: '10%', fontSize: 10, color: '#000000',fontFamily:'Lato-Regular'  }}>:</Text>
            <Text style={{ width: '45%', fontSize: 10, color: '#000000',fontFamily:'Lato-Regular'  }}>Umair</Text>
          </View>
          <View style={{ flexDirection: 'row', width: '80%', alignItems: 'center', marginBottom: '2%' }}>
            <Text style={{ width: '45%', fontSize: 10,color:'#696969',fontFamily:'Lato-Regular'  }}>Requested Date</Text>
            <Text style={{ width: '10%', fontSize: 10, color: '#000000', fontFamily:'Lato-Regular'  }}>:</Text>
            <View style={{ width: '45%', fontSize: 10, flexDirection: 'row' }}>
              <FontAwesome5 name="calendar" size={10} color={'#000'} />
              <Text style={{ fontSize: 10, color: '#000000', fontFamily:'Lato-Regular'  }}>12-04-2020</Text>
            </View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ fontSize: 12, fontWeight: '500', padding: '4%', backgroundColor: '#000000', color: '#FFFFFF', marginHorizontal: '2%', borderRadius: 100, textAlign: 'center', alignSelf: 'center', paddingHorizontal: '8%',fontFamily:'Lato-Regular'  }}>Accept</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {
            setRejectModalVisible(true)
          }}>
            <Text style={{ fontSize: 12, fontWeight: '500', padding: '4%', backgroundColor: '#FF3D3D', color: '#FFFFFF', marginHorizontal: '2%', borderRadius: 100, textAlign: 'center', alignSelf: 'center', paddingHorizontal: '8%', fontFamily:'Lato-Regular'  }}>Decline</Text>
          </TouchableOpacity>
        </View>
      </View>
      <Modal
...
const styles = StyleSheet.create({
  ...
  propertyTitle: {
    color: 'black', fontSize: 13, fontWeight: '700', flexShrink: 2, fontFamily:'Lato-Regular' 
  },
  propertyClaim: {
